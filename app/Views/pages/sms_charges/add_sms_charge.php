...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Add SMS Charge</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">SMS Charges</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Add SMS Charge</li>
                </ol>
            </nav>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        ?>
                        <form class="form-sample" method="post" action="<?= base_url(); ?>add-sms-charge" id="entryForm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="bank_id" class="form-control select--category select2">
                                                ...
                                                <?php foreach ($banks as $bank): ?>
                                                 <option name='bank_name' value="<?= $bank['id'] ?>" <?= (old('bank_id') == $bank['id']) ? 'selected' : '' ?>><?= $bank['name'] ?></option>
                                             <?php endforeach; ?>
                                         </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control select--value bg-white" name="value" value="<?= old('value') ?> "/>
