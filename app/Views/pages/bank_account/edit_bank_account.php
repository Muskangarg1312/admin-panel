            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-sample" method="post" action="<?= base_url(); ?>bank-accounts/<?= $bank_account['id'] ?>/edit">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="name" value="<?= $bank_account['name'] ?>" />
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" name="description" ><?= $bank_account['description'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
