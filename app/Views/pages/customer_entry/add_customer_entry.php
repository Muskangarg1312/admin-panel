...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">Add Customer Entry</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Customer Entries</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Add Customer Entry</li>
                </ol>
            </nav>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        ?>
                        <form class="form-sample" method="post" action="<?= base_url(); ?>add-customer-entry" id="entryForm">
                                        ...
                                        <div class="">
                                            <select name="parent_bank_id" class="form-control select--category select2">
                                                ...
                                                <?php foreach ($banks as $bank): ?>
                                                    <option data-json='<?= json_encode($bank) ?>' value="<?= $bank['name'] ?>" <?= (old('parent_bank_id') == $bank['id']) ? 'selected' : '' ?>><?= $bank['name'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                            ...
                                            <div class="">
                                                <select name="customer_id" class="form-control select--customer select2">
                                                    ...
                                                    <?php foreach ($customers as $customer): ?>
                                                        <option data-json='<?= json_encode($customer) ?>' value="<?= $customer['name'] ?>" <?= (old('customer_id') == $customer['id']) ? 'selected' : '' ?>><?= $customer['name'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
